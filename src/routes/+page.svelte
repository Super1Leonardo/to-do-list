...
<div class="flex justify-between h-dvh py-[2vh] flex-col">
    ...
    <div id='modal' class="fixed hidden left-0 justify-start py-[2vh] px-[5vw] flex-col top-[calc(50%-16vh)] right-0 z-20 bg-second mx-[2vw] rounded-lg h-[36vh] ">
        <h1 class="text-white text-3xl font-bold flex justify-center">Enter a task</h1>
    ...
    <div class="bg-black fixed bottom-0 left-0 right-0 z-10 h-[6vh] rounded-lg text-black font-bold text-2xl">
